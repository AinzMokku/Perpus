...
<div id="ukuran">
    ...
    <div class="qrcode">
        <img src="data:image/png;base64,{{ base64_encode(QrCode::format('png')->Color(250,250,250)->size(58)->BackgroundColor(50,60,66)->generate($anggota->no_anggota)) }}" style="margin-left:217px; margin-top:81px; position:absolute; border-radius:30%;">
    </div>
    <!-- QR CODE -->
    ...
    <div class="semua">
        ...
        <div class="no" style=" margin-left:79px; margin-top:-152px; position:absolute; font-size:12px; font-style:arial;"><strong style="color:whiblackte;">{{ $anggota->no_anggota }}</strong></div>
    </div>
<!-- Foto -->
</div>

<button id="cetak" class="btn pull-left">Cetak</button>
